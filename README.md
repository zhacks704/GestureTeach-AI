# 🖐️ GestureTeach AI — Touchless Windows Controller

**Control your entire Windows laptop with hand gestures — no mouse, no keyboard, no touch.**

Built for teachers presenting on a projector who want to walk around the room instead of standing at the laptop. Point to move the cursor, pinch to click, swipe to change slides, and control volume, brightness, File Explorer, and app switching — all through your webcam.

[![Python](https://img.shields.io/badge/Python-3.9%20--%203.11-3776AB?logo=python&logoColor=white)](https://www.python.org/)
...
6. [Gesture Reference](#6-gesture-reference)
7. [Presentation Mode Shortcuts](#7-presentation-mode-shortcuts)
8. [Safety Features](#8-safety-features)
9. [Performance Tuning](#9-performance-tuning-for-8gb-ram--low-end-laptops)
10. [Why Only the Mouse Gesture Felt Reliable Before](#9b-why-only-the-mouse-gesture-felt-reliable-before)
11. [Troubleshooting](#10-troubleshooting)
12. [Customizing Gestures](#11-customizing-gestures)
13. [License](#license)
...
Open **Command Prompt (CMD)** and run the following, step by step:

**1. Clone the repository**
```cmd
git clone https://github.com/your-username/GestureTeach_AI_Touchless_Windows_Controller.git
```

**2. Enter the project folder**
```cmd
cd GestureTeach_AI_Touchless_Windows_Controller
```
...
> Replace `your-username` in step 1 with your actual GitHub username/organization once this repository is published.
...
- Increase `MOUSE_SMOOTHING_SLOW` in `config.py` (higher = smoother, slightly more lag).
...
This project does not yet include a `LICENSE` file. If you plan to publish it
on GitHub, add one so others know how they're allowed to use, modify, or
distribute your code — for example, the permissive [MIT License](https://choosealicense.com/licenses/mit/)
is a common choice for open-source utility projects like this one. Until a
`LICENSE` file is added, all rights are reserved by default under standard
copyright law.
